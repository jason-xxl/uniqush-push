...
cd $TEMP/src/github.com/jason-xxl/uniqush-push/ && git checkout exp && go build
cp $TEMP/src/github.com/jason-xxl/uniqush-push/uniqush-push $TEMP/bin/uniqush-push 
cd $TEMP/
cd ..
